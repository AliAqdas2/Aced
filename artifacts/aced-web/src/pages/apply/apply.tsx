...
export default function Apply() {
  ...
  const form = useForm<z.infer<typeof applySchema>>({
    ...
    defaultValues: {
      universityId: '',
      courseId: 'placeholder-course-id', // In a real app we'd fetch courses for the selected uni
    ...
    <div className="min-h-screen bg-muted/20 py-12">
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="text-center mb-10">
          <h1 className="font-serif text-4xl font-bold mb-4">Apply as a Creator</h1>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 border rounded-lg bg-muted/30 flex items-center justify-center text-sm text-muted-foreground h-24">
                    [File Upload Component Placeholder for Transcripts/ID]
                  </div>
                </div>
      ...
      <Card className="max-w-md w-full text-center">
        <CardContent className="pt-12 pb-12 px-6">
          <div className="h-20 w-20 rounded-full bg-primary/10 text-primary flex items-center justify-center mx-auto mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-clipboard-check"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><path d="M15 2H9a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1Z"/><path d="m9 14 2 2 4-4"/></svg>
          </div>
          <h1 className="text-3xl font-bold font-serif mb-4">Application Received</h1>
          <p className="text-muted-foreground mb-8">
            Thanks for applying to be a creator on Aced! Our team is reviewing your academic credentials. We aim to process all applications within 48 hours.
          </p>
